...
class ChartsViewsTestCase(django.test.TestCase):
            ...
            json.dump({k: v for (k,
                                 v) in [(self.test_dict_value + str(i),
                                         self.test_dict_value.lower() + str(i)) for i in range(1,
                                                                                               self.tests_num + 1)] + [('GEOPHYSICAL_DEPTH_FROM',
                                                                                                                        'Geophysical depth from'),
                                                                                                                       ('geophysical_depth',
                                                                                                                        'Drilling depth from')] + [(self.test_meaning_name + str(i),
    ...
    def createTestValues(self):
        ...
        meanings.append(MeaningDict.objects.create(
            name=self.test_meaning_name + str(self.tests_num + 2), unit='DICT', section=sects[0]))
        for i in range(1, self.tests_num + 1):
            MeaningDictValue.objects.create(
                dict_id=meanings[-1], value=self.test_dict_value + str(i))
        ...
        meanings.append(MeaningDict.objects.create(id=606,
                                                   name=self.test_meaning_name + str(self.tests_num + 3),
                                                   unit='DICT',
                                                   section=MeaningSection.objects.get(name='Stratygrafia')))

        DictionaryMeasurement.objects.create(depth_from=0,
                                             depth_to=500000,
                                             meaning=meanings[-1],
                                             borehole=bhs[0],
                                             geophysical_depth=0,
                                             dictionary=MeaningDictValue.objects.create(dict_id=meanings[-1],
                                                                                        value="test_value"))
    ...
    def test01getCharts(self):
        ...
        self.assertListEqual(json.loads(views.charts(self.request,
                             ...
                             [{u'data': [[[0,
                                          ...
                                          [self.test_depth / 100,
                                           ...
                                           3]]],
                                 u'name': self.test_meaning_name.lower() + '1',
                                 u'unit': self.test_unit + '1'},
                              {u'name': self.test_meaning_name.lower() + '2',
                                 u'unit': self.test_unit + '2',
                                 u'data': [[[self.test_depth / 100 + 1,
                                             self.test_value + 2,
                                             self.test_depth / 100 + 2,
                                             self.test_geophysical_depth / 100 + 1,
                                             4]]]}])
        ...
        self.assertListEqual(json.loads(views.charts(self.request,
                             ...
                             [{u'data': [[[0,
                                 ...
                                 u'unit': self.test_unit + '1'},
                              {u'names': [{'label': self.test_meaning_name.lower() + '2'}],
                                 u'unit': self.test_unit + '2',
                                 u'data': [[[self.test_depth / 100 + 1,
                                             self.test_value + 2,
                                             self.test_depth / 100 + 2,
        ...
        self.assertListEqual(json.loads(views.charts(self.request,
                             ...
                             [{u'names': [{'label': self.test_meaning_name.lower() + '1'},
                                          {'label': self.test_meaning_name.lower() + str(self.tests_num + 1)}],
                                 u'unit': self.test_unit + '1',
                                 u'data': [[[self.test_depth / 100,
                                             self.test_value,
                                             self.test_depth / 100 + 1,
                                             self.test_geophysical_depth / 100,
                                             1]],
        ...
        self.assertListEqual(json.loads(views.charts(self.request,
                             ...
                             [{u'name': self.test_meaning_name.lower() + '1',
                               ...
                               u'data': [[[self.test_depth / 100,
                                           ...
                                           self.test_geophysical_depth / 100,
                                           1]]]},
                              {u'name': self.test_meaning_name.lower() + str(self.tests_num + 1),
                                 u'unit': self.test_unit + '1',
                                 u'data': [[[0,
                                             self.test_value + float(self.tests_num**2 + 1),
                                             0.01,
        ...
        self.request.GET = QueryDict(
            'lang=en&stop_depth=%d&strat=3&start_depth=0' %
            (self.test_depth / 100 + 1))
        self.assertListEqual(json.loads(views.charts(self.request,
                                                     1).content.decode('utf-8')),
                             [{u'name': self.test_meaning_name.lower() + '1',
