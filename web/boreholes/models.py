...
def get(_id = None):
    ...
    bholes = Borehole.objects.get(id=_id).to_dict() if _id else [bh.to_dict() for bh in Borehole.objects.all()]
...
class Borehole(models.Model):
    ...
    coordinateX = models.CharField(max_length = 64, default = '', blank = True, null = True)
    coordinateY = models.CharField(max_length = 64, default = '', blank = True, null = True)
