...
class MeaningsViewTestCase(django.test.TestCase):
    ...
    def createTestMeanings(self):
        ...
        for i in range(2):
            s = MeaningSection.objects.create(
                name=self.test_section_name + str(i))
            sects.append(s)

        for i in range(1, 3):
            MeaningValue.objects.create(
                name=self.test_meaning_name + str(i), unit=self.test_unit + str(i), section=sects[i % 2])

        for i in range(1, 3):
            temp = MeaningDict.objects.create(
                name=self.test_dict_name + str(i), section=sects[i % 2], unit='DICT')
            for j in range(2):
                MeaningDictValue.objects.create(
                    value=self.test_dict_value_name + str(j), dict_id=temp)

        MeaningImage.objects.create(
            name=self.test_meaning_name + str(10),
            unit='PICT',
    ...
    def createTestDictionaries(self, stratigraphy=False):
        ...
        for i in range(1, self.tests_num + 1):
            dictvals.append(MeaningDictValue.objects.create(
                dict_id=meanings[i - 1], value=self.test_dict_value + str(i)))
        ...
        if stratigraphy:
            for index, i in enumerate(stratigraphy_list):
                ...
                for i in range(
                        20 + index * 2,
                        20 + self.tests_num + index * 2):
                    dictvals.append(MeaningDictValue.objects.create(
                        dict_id=meanings[-1], value=self.test_dict_value + str(i), id=i))
                    for j in range(2):
                        DictionaryMeasurement.objects.create(dictionary=dictvals[-1],
                                                             meaning=meanings[-1],
                                                             borehole=bhs[0],
                                                             depth_from=self.test_depth + j * 100,
                                                             depth_to=self.test_depth + (j + i) * 100,
                                                             geophysical_depth=self.test_geophysical_depth + j * 100)
    ...
    def test01getMeanings(self):
        ...
        self.assertDictEqual(resp[0],
                             {u'name': six.text_type(self.test_section_name + str(0)),
                              u'meanings': sorted([{u'name': six.text_type(self.test_dict_name + str(2)),
                                                    u'id': six.text_type(4),
                                                    u'unit': u'DICT',
                                                    u'section': six.text_type(self.test_section_name + str(0))},
                                                   {u'name': six.text_type(self.test_meaning_name + str(2)),
                                                    u'id': six.text_type(2),
                                                    u'unit': six.text_type(self.test_unit + str(2)),
                                                    u'section': six.text_type(self.test_section_name + str(0))}],
                                                  key=lambda k: k['name'])})

        self.assertDictEqual(resp[1],
                             {u'name': six.text_type(self.test_section_name + str(1)),
                              u'meanings': sorted([{u'name': six.text_type(self.test_dict_name + str(1)),
                                                    u'id': six.text_type(3),
                                                    u'unit': u'DICT',
                                                    u'section': six.text_type(self.test_section_name + str(1))},
                                                   {u'name': six.text_type(self.test_meaning_name + str(1)),
                                                    u'id': six.text_type(1),
        ...
        self.assertListEqual(json.loads(views.meanings(self.req).content.decode('utf-8')),
                             [{u'name': six.text_type(self.test_section_name + str(0)),
                               u'meanings': [{u'name': six.text_type(self.test_dict_name + str(2)),
                                              u'id': six.text_type(4),
                                              u'unit': u'DICT',
                                              u'section': six.text_type(self.test_section_name + str(0))}]},
                              {u'name': six.text_type(self.test_section_name + str(1)),
                                 u'meanings': [{u'name': six.text_type(self.test_dict_name + str(1)),
                                                u'id': six.text_type(3),
                                                u'unit': u'DICT',
                                                u'section': six.text_type(self.test_section_name + str(1))}]},
                              {u'name': 'test_section',
        ...
        self.assertListEqual(json.loads(views.meanings(self.req).content.decode('utf-8')),
                             [{u'name': six.text_type(self.test_section_name + str(0)),
                               u'meanings': [{u'name': six.text_type(self.test_meaning_name + str(2)),
                                              u'id': six.text_type(2),
                                              u'unit': six.text_type(self.test_unit + str(2)),
                                              u'section': six.text_type(self.test_section_name + str(0))}]},
                              {u'name': six.text_type(self.test_section_name + str(1)),
                                 u'meanings': [{u'name': six.text_type(self.test_meaning_name + str(1)),
                                                u'id': six.text_type(1),
                                                u'unit': six.text_type(self.test_unit + str(1)),
                                                u'section': six.text_type(self.test_section_name + str(1))}]},
                              {u'name': 'test_section',
        ...
        self.assertListEqual(json.loads(views.meanings(self.req).content.decode('utf-8')),
                             [{u'name': self.test_section_name + str(0),
                               u'meanings': []},
                              {u'name': self.test_section_name + str(1),
                               u'meanings': []},
                              {u'name': 'test_section',
                                 u'meanings': [{u'name': self.test_meaning_name + str(10),
                                                u'id': str(5),
                                                u'unit': 'PICT',
                                                u'section': u'test_section'}]}])
    ...
    def test02getMeaning(self):
        ...
        self.assertDictEqual(resp,
                             {u'name': six.text_type(self.test_dict_name + str(1)),
                              u'id': six.text_type(3),
                                 u'dictvals': [{'value': self.test_dict_value_name + str(0),
                                                'id': 1,
                                                u'dict_id': 3},
                                               {'value': self.test_dict_value_name + str(1),
                                                'id': 2,
                                                u'dict_id': 3}],
                                 u'section': self.test_section_name + str(1),
                                 'type': 'dict'})
        ...
        self.assertDictEqual(
                    ...
                    5).content.decode('utf-8')),
            {
                u'name': six.text_type(
                    self.test_meaning_name +
                    str(10)),
                u'id': six.text_type(5),
                u'section': 'test_section',
                'type': 'pict'})
    ...
    def test02addMeaning(self):
        ...
        for test_content in ['',
                             '5',
                             json.dumps({'name': self.test_meaning_name}),
                             json.dumps({'unit': self.test_unit}),
                             json.dumps({'name': self.test_meaning_name,
                                         u'section': self.test_section_name})]:
        ...
        temp_query = {
            'name': self.test_long_name,
            'type': 'normal',
            'unit': self.test_unit,
            'section': self.test_section_name + str(1)}

        self.req.read = lambda: json.dumps(temp_query).encode()
        self.assertRaises(
            MeaningSection.DoesNotExist,
            views.meanings,
            self.req)
        ...
        self.assertListEqual(json.loads(views.meanings(self.req).content.decode('utf-8')),
                             [{u'name': self.test_section_name + str(0),
                               u'meanings': [{u'name': six.text_type(self.test_meaning_name + str(0)),
                                              u'unit': six.text_type(self.test_unit),
                                              u'id': six.text_type(1),
        ...
        self.req.read = lambda: json.dumps(temp_query).encode()
        self.assertEqual(len(json.loads(views.meanings(
            self.req).content.decode('utf-8'))[0]['meanings']), 2)

        MeaningSection.objects.create(name=self.test_section_name + str(1))
        self.req.read = lambda: json.dumps(
            {
                'type': 'dict',
                'name': self.test_dict_name + str(0),
                'section': self.test_section_name + str(1),
                'dictvals': [
                    self.test_dict_value_name + str(i) for i in range(2)]}).encode()

        self.assertDictEqual(
            json.loads(
                views.meanings(
                    self.req).content.decode('utf-8'))[1],
            {
                u'name': six.text_type(
                    self.test_section_name +
                    str(1)),
                u'meanings': [
                    {
                        u'name': six.text_type(
                        ...
                        u'id': six.text_type(3),
                        u'unit': u'DICT',
                        u'section': six.text_type(
                            self.test_section_name +
                            str(1))}]})

        vals = MeaningDictValue.objects.filter(
            dict_id=MeaningDict.objects.get(
                name=self.test_dict_name +
                str(0))).order_by('value')
        for i in range(2):
        ...
        self.assertDictEqual(
            json.loads(
                views.meanings(
                    self.req).content.decode('utf-8'))[2],
            {
                u'name': six.text_type(
                    self.test_section_name +
                    str(2)),
        ...
        self.req.read = lambda: json.dumps(
            {
                'type': 'p',
                'name': self.test_dict_name + str(20),
                'section': self.test_section_name + str(2),
                'dictvals': [
                    self.test_dict_value_name + str(i) for i in range(2)]}).encode()
    ...
    def test03modifyMeaning(self):
        ...
        self.req.read = lambda: json.dumps(
            {'name': self.test_meaning_name + '_modified', 'type': 'normal'}).encode()
        self.assertRaises(
            MeaningValue.DoesNotExist,
            views.meanings,
            self.req,
        ...
        self.req.read = lambda: json.dumps(
            {
                'name': self.test_meaning_name + '_modified',
                'type': 'normal',
                u'unit': six.text_type(
                    self.test_unit + str(1))}).encode()
        ...
        self.req.read = lambda: json.dumps(
            {'type': 'normal', 'unit': self.test_unit + '_modified'}).encode()
        resp = json.loads(views.meanings(self.req, 1).content.decode('utf-8'))
        ...
        self.req.read = lambda: json.dumps(
            {
                'section': self.test_section_name + '_modified',
                'type': 'normal',
                u'unit': six.text_type(
                    self.test_unit + '_modified')}).encode()
        self.assertRaises(MeaningSection.DoesNotExist,
                          views.meanings, self.req, 1)

        self.req.read = lambda: json.dumps(
            {
                'section': self.test_section_name + str(0),
                'type': 'normal',
                u'unit': six.text_type(
                    self.test_unit + '_modified')}).encode()
        resp = json.loads(views.meanings(self.req, 1).content.decode('utf-8'))
        ...
        self.req.read = lambda: json.dumps(
            {'section': self.test_section_name + str(0), 'type': 'pict', u'name': 'a'}).encode()
        resp = json.loads(views.meanings(self.req, 1).content.decode('utf-8'))
    ...
    def test04modifyDictMeaning(self):
        ...
        self.req.read = lambda: json.dumps(
            {
                'name': self.test_dict_name + '_modified',
                'type': 'dict',
                'dictvals': [
                    self.test_dict_value_name + str(0) + '_modified']}).encode()

        resp = json.loads(views.meanings(self.req, 4).content.decode('utf-8'))
        self.assertDictEqual(resp[0],
                             {u'name': six.text_type(self.test_section_name + str(0)),
                              u'meanings': sorted([{u'name': six.text_type(self.test_meaning_name + str(2)),
                                                    u'id': six.text_type(2),
                                                    u'unit': six.text_type(self.test_unit + str(2)),
                                                    u'section': six.text_type(self.test_section_name + str(0))},
                                                   {u'name': six.text_type(self.test_dict_name + '_modified'),
                                                    u'id': six.text_type(4),
                                                    u'unit': u'DICT',
                                                    u'section': six.text_type(self.test_section_name + str(0))}],
                                                  key=lambda k: k['name'])})
        ...
        self.assertDictEqual(resp[1],
                             {u'name': six.text_type(self.test_section_name + str(1)),
                              u'meanings': sorted([{u'name': six.text_type(self.test_meaning_name + str(1)),
                                                    u'id': six.text_type(1),
                                                    u'unit': six.text_type(self.test_unit + str(1)),
                                                    u'section': six.text_type(self.test_section_name + str(1))},
                                                   {u'name': six.text_type(self.test_dict_name + str(1)),
        ...
        self.assertDictEqual(resp[2],
                             {u'name': 'test_section',
                              u'meanings': [{u'section': 'test_section',
                                             u'id': six.text_type(5),
                                             u'unit': 'PICT',
                                             u'name': six.text_type(self.test_meaning_name + str(10))}]})

        vals = MeaningDictValue.objects.filter(
            dict_id=MeaningDict.objects.get(
                name=self.test_dict_name +
                '_modified')).order_by('value')
        self.assertEqual(len(vals), 1)
        self.assertEqual(
            vals[0].value,
            self.test_dict_value_name +
            str(0) +
            '_modified')
        ...
        self.req.read = lambda: json.dumps(
            {
                'dictvals': [
                    self.test_dict_value_name + '_modified'],
                u'section': self.test_section_name + str(1),
                'type': 'dict'}).encode()
        resp = json.loads(views.meanings(self.req, 2).content.decode('utf-8'))
        self.assertDictEqual(resp[0],
                             {u'name': six.text_type(self.test_section_name + str(0)),
                              u'meanings': [{u'name': six.text_type(self.test_dict_name + '_modified'),
                                             u'id': six.text_type(4),
                                             u'unit': u'DICT',
                                             u'section': six.text_type(self.test_section_name + str(0))}]})
        self.assertDictEqual(resp[1],
        ...
        self.req.read = lambda: json.dumps(
            {
                'unit': self.test_unit + '_modified',
                'section': self.test_section_name + str(0),
                'type': 'normal'}).encode()
        resp = json.loads(views.meanings(self.req, 3).content.decode('utf-8'))
        self.assertDictEqual(resp[0],
                             {u'name': six.text_type(self.test_section_name + str(0)),
                              u'meanings': sorted([{u'name': six.text_type(self.test_dict_name + '_modified'),
                                                    u'id': six.text_type(4),
                                                    u'unit': u'DICT',
                                                    u'section': resp[0]['name']},
                                                   {u'name': six.text_type(self.test_dict_name + str(1)),
                                                    u'id': six.text_type(7),
    ...
    def test05deleteMeaning(self):
        ...
        resp = json.loads(views.meanings(self.req, 4).content.decode('utf-8'))
        self.assertEqual(len(resp[0]['meanings']) +
                         len(resp[1]['meanings']), 3)
        self.assertEqual(len(MeaningDictValue.objects.all()), 2)
    ...
    def test06getSections(self):
        ...
        self.createTestMeanings()
        self.assertListEqual(json.loads(views.sections(self.req).content.decode(
            'utf-8')), [self.test_section_name + str(i) for i in range(2)] + ['test_section'])
    ...
    def test07addSection(self):
        ...
        for cont in ['', '4', {}, []]:
            ...
            self.assertEqual(temp, 1)
        self.req.read = lambda: json.dumps(
            {'name': self.test_long_name}).encode()
        self.assertRaises(DataError, views.sections, self.req)

        self.req.read = lambda: json.dumps(
            {'name': self.test_section_name + str(0)}).encode()
        self.assertListEqual(json.loads(views.sections(self.req).content.decode(
            'utf-8')), [self.test_section_name + str(0)])
    ...
    def test08ModifySection(self):
        ...
        self.req.read = lambda: json.dumps(
            {'name': self.test_section_name + str(1)}).encode()
        self.assertRaises(
            SectionsDuplicated,
            views.sections,
            self.req,
        ...
        self.req.read = lambda: json.dumps(
            {'name': self.test_section_name + '_modified'}).encode()
        self.assertListEqual(
            json.loads(
                views.sections(
                    self.req,
                    self.test_section_name +
                    str(0)).content.decode('utf-8')),
            [
                six.text_type(
                    self.test_section_name +
                    str(1)),
                             ...
                             [{u'name': six.text_type(self.test_section_name + str(1)),
                               u'meanings': [{u'name': six.text_type(self.test_dict_name + str(1)),
                                             ...
                                             {u'name': six.text_type(self.test_meaning_name + str(1)),
                                              ...
                                              u'unit': six.text_type(self.test_unit + str(1)),
                                              u'section': six.text_type(self.test_section_name + str(1))}]},
                              {u'name': six.text_type(self.test_section_name + '_modified'),
                                 u'meanings': [{u'name': six.text_type(self.test_dict_name + str(2)),
                                                u'id': six.text_type(4),
                                                u'unit': u'DICT',
